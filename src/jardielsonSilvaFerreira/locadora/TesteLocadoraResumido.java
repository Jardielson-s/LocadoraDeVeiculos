...
// Tentar devolução de veiculo de veiculo não existente
  ...
  public   void testeAumentarDiaria() {
   ...
   public void testeFaturamentoTotal()  {
        ...
        locadora.registrarAluguel("X-911", amanha, 4, 1234);// Valor do aluguel = 178.0   (moto)
        ...
        assertEquals(400.68, locadora.faturamentoTotal(1, ontem, amanha), 0.01);// Faturamento total de motos
...
*/
    ...
    public void testeInserirVeiculo() {
        ...
        assertEquals(50, recuperado.getValorDiaria(),0);
